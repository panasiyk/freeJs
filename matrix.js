...
var startModule = (function () {
    ...
    startModuleObj.buttonClickHandler = function (button){
        button.style.display = "none";
        readData();
        createMatrix();
        startModuleObj.createCloneArray();
        createTable();
        startModuleObj.addEventLisener();
        startModuleObj.fillTableWithData();
        startModuleObj.fillAverageBlockWithData();
        startModuleObj.fillSumBlockWithData();
        startModuleObj.createClassForFindPercent();
    };
    ...
    startModuleObj.createCloneArray=function (){
        arrayOfObjectsClone=[];
        for(var i=0; i<rowsCount; i++){
            for(var j=0; j<columsCount; j++){
    ...
    startModuleObj.fillTableWithData = function (){
        for(var i=0;i<rowsCount;i++){
            for(var j=0;j<columsCount;j++){
    ...
    startModuleObj.addEventLisener = function (){
        for(var i=0; i<rowsCount; i++){
            for(var j=0; j<columsCount; j++){
    ...
    startModuleObj.fillAverageBlockWithData = function (){
    ...
    startModuleObj.fillSumBlockWithData = function (){
        for (var i=0; i<rowsCount; i++){
            var sum=0;
            for(var j=0; j<columsCount; j++){
    ...
    startModuleObj.createClassForFindPercent = function () {
        for (var i=0; i<rowsCount; i++){
            for(var j=0; j<=columsCount; j++){
...
function buttonClickHandlerForAddNewRow() {
    ...
    createTableOfnewRow();
    startModule.addEventLisener();
    startModule.fillTableWithData();
    startModule.fillAverageBlockWithData();
    startModule.fillSumBlockWithData();
    startModule.createClassForFindPercent();
}
